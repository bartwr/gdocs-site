...
function printDocTitle(auth) {
  ...
  docs.documents.get({
    documentId: '1J3gT-_NmdR0Jj5tJl79uUYDBC09siruD5idlmlNwz7Q',
  }, (err, res) => {
    ...
    // git@github.com:Mr0grog/google-docs-to-markdown.git
    // res.data.body.content.map(x => {
    //   if(! x.paragraph || ! x.paragraph.elements) return;
    //   formatContent(x.paragraph.elements);
    // });
  });
}
